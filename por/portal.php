...
<body>
    <div class="body0">
        ...
        -->
            ...
            <div class="top">
                <div class="lockdiv">
                    <img id="padLock" style="width:15px; " src="/defaults/unlock.png" alt="">
                </div>
                <div class="set">
                   <a href="/por/PortEdit.php">
                    <img class="setBtn " src="/logos/settings_icons.png" alt="">
                   </a>
                </div>
            </div>
            ...
            <div class="hedadiv">
                <span id="skuname">
                    <!--school motto here-->iicomics College
                </span>
                <br>
                <small id="motto">
                    <!--school motto here-->study is play
                </small>
            </div>
        ...
        <div class="AvataDiv0">
            <div class="AvataDiv">
                <div class="inAVDiv">
                    <!-- profile img-->
                    <img style="width: 100%; height: 100%; border-radius: 50%;" id="stAvata" src="<?php if (isset($profilePic)) echo $profilePic; ?>">
        ...
        <div class="usernamediv">
            <!--username -->
            <h3 class="stuName">benz10<?php //echo $username 
                                        ?></h3>
        </div>
        ...
        <div class="body">
            <section>
                <div class="namescont">
                    <div class="namesdiv">
                        <label> surname:</label>
                        <span class="stuName">Ileoegben <?php // echo $surname(); 
                                                        ?></span>
                    </div>
                    <div class="namesdiv">
                        <label>firstname:</label>
                        <span class="stuName">charles <?php //echo $Fname();  
                                                        ?></span>
                    </div>
                    <div class="namesdiv">
                        <label>middle name:</label>
                        <span class="stuName">Ojehomon <?php // echo $Mname();    
                                                        ?></span>
                    </div>
                </div>
                ...
                <div id="reqdiv0" style="margin-top:5px; border-top:solid 1px rgb(185, 118, 160);">
                    ...
                    <div style=" margin-top:20px;  margin-right:10px; border-radius:10px; background-color:#fff; padding:10px; box-shadow:rgb(170, 97, 121) -1px -1px 1em -10px;">
